...
class Caller:
    def __init__(self, endpoint, context, number, email, src_files = [], file_upload_objects = [], quality = 'normal'):
    ...
    def call(self, dry_run = False):
        ...
        agent = Agent(src_files = self.src_files, file_upload_objects = self.file_upload_objects, quality = self.quality)
